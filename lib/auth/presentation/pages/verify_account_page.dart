...
class _VerifyAccountPageState extends State<VerifyAccountPage> {
  ...
  void initState() {
    super.initState();
    _contactCtrl = TextEditingController(text: widget.usernameOrEmail);
  ...
  String _t(String key, {bool listen = true}) {
    ...
    final sw = {
      ...
      'contact_label': 'Barua pepe au namba ya simu',
      'contact_hint_email': 'mfano: wewe@barua.com',
      'contact_hint_phone': 'mfano: +2557XXXXXXX',
      'contact_required': 'Weka barua pepe au namba ya simu halali.',
    ...
    final en = {
      ...
      'contact_hint_email': 'e.g. you@example.com',
      'contact_hint_phone': 'e.g. +2557XXXXXXX',
      'contact_required': 'Please enter a valid email or phone number.',
  ...
  void _sendCode() {
    ...
    if (!_isValidId(id)) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(_t('contact_required', listen: false))));
      return;
    }
    context.read<VerificationBloc>().add(SendVerificationCode(channel, id));
  }
  ...
  void _confirmCode() {
    ...
    context.read<VerificationBloc>().add(ConfirmVerificationCode(channel, id, code));
  }
  ...
  bool _isValidId(String value) => channel == VerifyChannel.email ? _looksLikeEmail(value) : _looksLikePhone(value);

  String _currentIdentifier() => _contactCtrl.text.trim().isEmpty ? widget.usernameOrEmail.trim() : _contactCtrl.text.trim();
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        keyboardType: channel == VerifyChannel.email ? TextInputType.emailAddress : TextInputType.phone,
                        decoration: InputDecoration(
                          labelText: _t('contact_label'),
                          hintText: channel == VerifyChannel.email ? _t('contact_hint_email') : _t('contact_hint_phone'),
                          prefixIcon: Icon(channel == VerifyChannel.email ? Icons.email_outlined : Icons.sms_outlined),
