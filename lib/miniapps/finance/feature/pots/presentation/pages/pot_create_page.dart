...
class _PotCreatePageState extends State<PotCreatePage> with TickerProviderStateMixin {
  ...
  static const _strings = {
    ...
    'kyc_required': {'en': 'KYC verification is required to {feature}', 'sw': 'Uthibitisho wa utambulisho unahitajika {feature}'},
    'plan_created_success': {'en': 'Savings plan created successfully!', 'sw': 'Mpango wa akiba umeundwa kikamilifu!'},
  };
          ...
          body: BlocConsumer<PotsBloc, PotsState>(
                  listener: (ctx, state) {
                    if (state is PotError) {
                      ...
                      if (mounted) {
                        _showSuccessFeedback(_t('plan_created_success'));
                        Future.delayed(const Duration(milliseconds: 500), () {
                          if (mounted) {
                            // Navigate back to home shell on Pots tab
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    if (accountError != null) ...[
                                      _buildErrorBanner(
                                        _t('account_error',
                                            params: {'error': MessageMapper.getAccountFriendlyError(accountError)}),
