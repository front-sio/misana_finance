...
class _OnboardingPageState extends State<OnboardingPage> with TickerProviderStateMixin {
  ...
  final List<OnboardContent> _pages = [
    OnboardContent(
      ...
      title: 'Pay Your Career',
      subtitle: 'Invest 20% of your income back into your career, business, or passion to build your future.',
      backgroundColor: BrandColors.purple,
    ),
    OnboardContent(
      image: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f',
      title: 'Build Career Discipline',
      subtitle: 'Commit 20% of your earnings to fuel your professional growth and unlock your potential.',
      backgroundColor: BrandColors.orange,
    ),
    OnboardContent(
      image: 'https://images.unsplash.com/photo-1565514020179-026b92b84bb6',
      title: 'Invest in Your Craft',
      subtitle: 'Choose your contribution rhythm — daily, weekly, or monthly — and master your career journey.',
      backgroundColor: BrandColors.purple,
    ),
    OnboardContent(
      image: 'https://images.unsplash.com/photo-1559526324-593bc073d938',
      title: 'Grow Your Potential',
      subtitle: 'Track how your career investments compound into professional success and financial freedom.',
      backgroundColor: BrandColors.orange,
    ),
    OnboardContent(
      image: 'https://images.unsplash.com/photo-1563986768817-257bf91c5e9d',
      title: 'Your Business, Your Future',
      subtitle: 'Your career contributions are protected with bank-grade security as you build your empire.',
      backgroundColor: BrandColors.purple,
    ),
  ];
