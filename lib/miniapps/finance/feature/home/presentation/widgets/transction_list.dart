      ...
      children: [
        Padding(
          ...
          child: Row(
            children: [
              Text(
                isSw ? 'Miamala ya Hivi Karibuni' : 'Recent Transactions',
              ...
              if (onViewAll != null)
                AnimatedPress(
                  child: TextButton(
                    ...
                    child: Text(isSw ? 'Ona Yote' : 'View All'),
                  ),
                ),
            ],
          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            context.watch<LocaleCubit>().state.languageCode == 'sw' 
                ? 'Hakuna miamala bado' 
                : 'No transactions yet',
            style: TextStyle(
              fontSize: 16,
